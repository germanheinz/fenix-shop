    ...
    <div className="flex text-center justify-center mt-10 mb-32">
        <nav aria-label="Page navigation example">
            ...
            { allPages.map( ( page, index ) => (
                <li key={ page } className={`page-item ${ page === currentPage ? 'bg-gray-200' : '' }`}>
                    <Link
                        className={clsx(
                            "page-link relative block py-1.5 px-3 rounded border-0 outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 focus:shadow-none",
